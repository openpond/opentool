 ...
 * Generated at: 2025-11-20T19:43:40.925Z
 *
...
export const OPENTOOL_VERSION = "0.7.10";
...
`,
  "aave-unstake.ts": `import { z } from "zod";
...
`,
  "aave-stake.ts": `// GET-only scheduled staking example
export const profile = {
  description: "Stake 100 USDC daily at 12:00 UTC",
  fixedAmount: "100",
  tokenSymbol: "USDC",
...
`,
  "src/wallets/providers/private-key.ts": `import { createPublicClient, createWalletClient, http, type PublicClient, type WalletClient } from "viem";
...
`,
  "src/wallets/types.ts": `import type { Chain, PublicClient, WalletClient } from "viem";
