...
var ai_code_suggestion_exports = {};
__export(ai_code_suggestion_exports, {
  POST: () => POST,
  metadata: () => metadata,
  schema: () => schema
});
module.exports = __toCommonJS(ai_code_suggestion_exports);
...
var schema = z.object({
  language: z.enum(["typescript", "python", "rust", "go", "bash"]).describe("Target programming language"),
  task: z.string().min(5).describe("What the code snippet should accomplish"),
  constraints: z.array(z.string().min(1)).default([]).describe("Additional requirements, such as libraries or style"),
  tests: z.boolean().default(true).describe("Whether to include a lightweight test or usage example")
});
var metadata = {
